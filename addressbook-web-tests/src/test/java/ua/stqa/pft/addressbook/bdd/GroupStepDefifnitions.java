package ua.stqa.pft.addressbook.bdd;
...
public class GroupStepDefifnitions {

    private ApplicationManager app;
    private Groups groups;
    private GroupData newGroup = new GroupData();
    ...
    public void createGroup(String name, String header, String footer) {
        app.goTo().group();
        newGroup.withName(name).withHeader(header).withFooter(footer);
