 ...
 * 2018-10-30T12:41:42.944+02:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "BLZService",
                  wsdlLocation = "file:src/main/resources/BLZService.wsdl",
...
public class BLZService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/BLZService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BLZService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/BLZService.wsdl");
        }
        WSDL_LOCATION = url;
    }
