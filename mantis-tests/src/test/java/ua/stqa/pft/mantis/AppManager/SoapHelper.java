...
import ua.stqa.pft.mantis.Models.Issue;
import ua.stqa.pft.mantis.Models.Project;
...
public class SoapHelper {
    ...
    private MantisConnectPortType getMantisConnect() throws ServiceException, MalformedURLException {
        return new MantisConnectLocator().getMantisConnectPort(new URL("http://localhost/mantisbt-2.18.0/api/soap/mantisconnect.php"));
    }
